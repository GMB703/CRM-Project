  ...
  const featureOptions = [
    {
      ...
      description: "Manage contacts, leads, and customer interactions",
    },
    {
      value: "projects",
    ...
    },
    {
      ...
      description: "Create invoices, track payments, and manage finances",
    },
    {
      value: "estimates",
      label: "Estimates & Quotes",
      description: "Generate professional estimates and quotes",
    },
    {
      value: "inventory",
      label: "Inventory Management",
      description: "Track products, materials, and stock levels",
    },
    {
      value: "reporting",
      label: "Advanced Reporting",
      description: "Generate insights and business analytics",
    },
  ];
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600">
                Select the features you want to enable for your organization
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg space-y-4">
              <div>
                ...
                <p className="text-gray-600">
                  Industry:{" "}
                  {
                    industryOptions.find((i) => i.value === formData.industry)
                      ?.label
                  }
                </p>
