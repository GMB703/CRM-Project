...
export const selectEntityLoading = (entity) => (state) => state.ui.loading[entity]
export const selectEntityFilters = (entity) => (state) => state.ui.filters[entity]
export const selectEntitySort = (entity) => (state) => state.ui.sort[entity]
export const selectEntityPagination = (entity) => (state) => state.ui.pagination[entity]
